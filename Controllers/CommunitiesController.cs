...
namespace Lab4.Controllers
{
    public class CommunitiesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ID)
        {
            ...
            communityViewModel.Communities = await _context.Communities.Include(i => i.CommunityMemberships).ThenInclude(i => i.Student).AsNoTracking().OrderBy(i => i.Title).ToListAsync();
